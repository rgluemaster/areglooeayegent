...
import projectAgent.environment.NArmedBanditEnvironment;
...
*/
public class RunAgentSmithOnNArmedBandits{
	...
	public static void main(String[] args){
		...
		EnvironmentInterface theEnvironment=new NArmedBanditEnvironment();
